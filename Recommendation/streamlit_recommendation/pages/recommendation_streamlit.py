...
def get_data():
    ...
    movies = pd.read_csv(get_file_path("movies.csv"), usecols=["movieId", "title", "genres"])
    ratings = pd.read_csv(get_file_path("ratings.csv"), usecols=["userId", "movieId", "rating"])
...
recommender_system = RecommenderSystem(ratings_df, items_df, get_file_path("my_ratings_stream.pkl"),"user_id", item_min=30, user_min=50, item_identifier=["title", "year"], rating_mid_point=6)
